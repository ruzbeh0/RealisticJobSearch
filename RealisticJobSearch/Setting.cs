...
namespace RealisticJobSearch
{
    ...
    public class Setting : ModSetting
    {
        ...
        public float weight_free_jobs = 0.28f;
        public float weight_total_jobs = 0.72f;
        public float alpha_jobs = 1.2f;
        public float beta_minute = 0.9f;
        public float min_accept = 0.15f;
        public float max_accept = 0.98f;
    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            {
                { m_Setting.GetSettingsLocaleID(), "RealisticJobSearch" },
